(function (e, t) {
  ...
  return (function (e) {
    ...
    function (e, t, n) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.ddSdk = void 0);
      var r = n(4),
        o = n(4);
      ...
      var i = n(2);
      n(253), (t.ddSdk = new i.Sdk(r.getENV()));
    },
    function (e, t, n) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        (t.genBizStoreParamsDealFn = function (e) {
          var t = Object.assign({}, e);
          return "string" != typeof t.params
            ? ((t.params = JSON.stringify(t)), t)
            : t;
        });
    },
    function (e, t, n) {
      ...
      function r(e, t) {
        var n = e && e.vs;
        return "object" == typeof n && t.platformSub
          ? n[t.platformSub]
          : "string" == typeof n
          ? n
          : void 0;
        ...
        function e(e) {
          ...
          (this.configJsApiList = []),
            ...
            (this.setAPI = function (e, n) {
              t.invokeAPIConfigMapByMethod[e] = Object.assign(
                t.invokeAPIConfigMapByMethod[e] || {},
                n
              );
            }),
            (this.setPlatform = function (e) {
              (t.isBridgeDrity = !0),
                ...
                e.platform === t.env.platform &&
                  e.bridgeInit().catch(function (e) {
                    d.formatLog(
                      d.diagnosticMessageMap.auto_bridge_init_error,
            ...
            (this.invokeAPI = function (e, n, r) {
              return (
                void 0 === n && (n = {}),
                void 0 === r && (r = !0),
                t.apiHandler.start({ method: e, params: n, isAuthApi: r })
              );
            }),
              ...
              var t = Object.assign(
                {
                  on: function () {
                    return d.formatLog(
                      d.diagnosticMessageMap.not_support_event_on
                    );
                  },
                  off: function () {
                    return d.formatLog(
                      d.diagnosticMessageMap.not_support_event_off
                    );
                  },
                },
                e.event
              );
              return o(o({}, e), { event: t });
            }),
            (this.env = e),
            (this.bridgeInitFn = function () {
              ...
              if (n)
                t.bridgeInitFnPromise = n.bridgeInit().catch(function (e) {
                  return (
                    d.formatLog(d.diagnosticMessageMap.JsBridge_init_fail),
                    Promise.reject(e)
                  );
                });
              else {
                var r = d.formatLog(
                  d.diagnosticMessageMap.not_support_env,
                  e.platform
                );
          ...
          (this.exportSdk = {
            config: function (r) {
              ...
              Object.keys(r).forEach(function (e) {
                ...
                o
                  ? (d.formatLog(
                      d.diagnosticMessageMap.config_debug_deprecated
                    ),
                    n(r))
                  : t.hadConfig
                  ? d.formatLog(d.diagnosticMessageMap.repeat_config)
                  : (r.jsApiList && (t.configJsApiList = r.jsApiList),
                    (t.hadConfig = !0),
                    t.bridgeInitFn().then(
                      function (n) {
                        ...
                        o.authParamsDeal && (i = o.authParamsDeal(i)),
                          n(o.authMethod, i)
                            .then(function (e) {
                              (t.isReady = !0), t.p.resolve(e);
                            })
                            .catch(function (e) {
                              (t.isReady = !1), t.p.reject(e);
                            });
                      },
                      function (e) {
                        d.formatLog(
                          d.diagnosticMessageMap.JsBridge_init_fail_dd_config
                        ),
                          t.p.reject(e);
                      }
                    ));
            ...
            ready: function (e) {
              !1 === t.hadConfig
                ? (d.formatLog(
                    d.diagnosticMessageMap.dd_config_wrap_deprecated
                  ),
            ...
            on: function (n, r) {
              t.bridgeInitFn().then(function () {
                var o;
                null === (o = t.platformConfigMap[e.platform].event) ||
                  void 0 === o ||
                  o.on(n, r);
              });
            },
            ...
            checkJsApi: function (n) {
              ...
              return (
                n.jsApiList &&
                  n.jsApiList.forEach(function (n) {
            ...
            _invoke: function (e, n) {
              return void 0 === n && (n = {}), t.invokeAPI(e, n, !1);
            },
          }),
            this.initApiMiddleware();
        }
        return (
          (e.prototype.useApiMiddleware = function (e) {
            if (!i.isFunction(e))
      ...
      (function (e) {
        ...
        (t.getENV = function () {
          var e,
            n,
            o = t.getUA(),
            s = /iPhone|iPad|iPod|iOS/i.test(o),
            u = /Android/i.test(o),
            c = /DingTalk/i.test(o),
            l = /dd-web/i.test(o),
            v = "object" == typeof nuva,
            f = "object" == typeof dd && "function" == typeof dd.dtBridge,
            p = /TaurusApp/.test(o),
            _ = p && !c,
            E = p && c,
            N =
              ...
              null !== my &&
              void 0 !== my.alert,
            P = p && /dingtalk-win/.test(o),
            h = !P && _ && s,
            M = !P && _ && u,
            m = !P && E && s,
            g = !P && E && u,
            b = (f && s) || (v && s),
            k = c || a.default.isDingTalk,
            y = (s && k) || a.default.isWeexiOS || b,
            I = (u && k) || a.default.isWeexAndroid,
            A = f,
            S = l,
            $ = r.APP_TYPE.WEB;
          if (N) $ = r.APP_TYPE.MINI_APP;
          else if (S) $ = r.APP_TYPE.WEBVIEW_IN_MINIAPP;
          else if (A) $ = r.APP_TYPE.MINI_APP;
          ...
          R &&
            !j &&
            (w = o.match(/DingTalk\(([a-zA-Z0-9\.-]+)\)/)) &&
            w[1] &&
            (j = w[1]);
          var F,
            x = r.ENV_ENUM_SUB.noSub;
          if (
            (P
              ? ((F = r.ENV_ENUM.gdtPc), (x = r.ENV_ENUM_SUB.win))
              : (F = h
                  ? r.ENV_ENUM.gdtIos
                  : M
                  ? r.ENV_ENUM.gdtAndroid
                  : m
                  ? r.ENV_ENUM.gdtStandardIos
                  : g
                  ? r.ENV_ENUM.gdtStandardAndroid
                  : y
                  ? r.ENV_ENUM.ios
                  : I
                  ? r.ENV_ENUM.android
                  ...
                  : D && D.platform
                  ? D.platform
                  : r.ENV_ENUM.notInDingTalk),
            F === r.ENV_ENUM.pc)
          ) {
            x =
              o.indexOf("Macintosh; Intel Mac OS") > -1
                ? r.ENV_ENUM_SUB.mac
                : r.ENV_ENUM_SUB.win;
          }
          return {
        ...
        return (function (e) {
          ...
          201: function (e, t, n) {
            ...
            try {
              ...
              if (f && f[0]) var l = JSON.parse(f[0]);
            } catch (e) {
              l = {};
            }
            l.hostOrigin &&
              ".dingtalk.com" ===
                l.hostOrigin.split(":")[1].slice(0 - ".dingtalk.com".length) &&
              l.containerId &&
              ((s = !0), (u = l.hostOrigin), (c = l.containerId));
            var p = {},
              ...
              N = null;
            window.top !== window
              ? ((N = window.top), p._resolve())
              : "object" == typeof dingtalk &&
                "object" == typeof dingtalk.platform &&
                "function" == typeof dingtalk.platform.invokeAPI &&
                ((N = window), p._resolve()),
                ...
                if (n === u)
                  if ("response" === t.type && t.msgId) {
                    var r = t.msgId,
                      i = d.getMsyById(r);
                    i &&
                      i.methodName !== a.SYS_EVENT &&
                      i.receiveResponse(t.body, !t.success);
              ...
              (t.invokeAPI = function (e, t) {
                ...
                return (
                  s &&
                    _.then(function () {
                      N && N.postMessage(n.getPayload(), u), d.addPending(n);
                    }),
                  n
                );
              });
          ...
          203: function (e, t, n) {
            ...
            var r = n(716),
              ...
              d = function () {
                return (
                  1e3 * (1e3 * a + Math.floor(1e3 * Math.random())) +
                  (++i % 1e3)
                );
              },
              s = { code: 408, reason: "timeout" },
              u = { TIMEOUT: "_timeout", FINISH: "_finish" },
              c = { timeout: -1 },
              l = function (e, t, n, r) {
                (this.id = d()),
                  (this.methodName = t),
            ...
            (l.prototype._initTimeout = function () {
              this._clearTimeout(),
                this.option.timeout > 0 &&
                  (this._timeoutTimer = setTimeout(
                    function () {
                      this.receiveEvent(u.TIMEOUT), this.receiveResponse(s, !0);
                    }.bind(this),
                    this.option.timeout
                  ));
            }),
              ...
              (l.prototype._handleMsg = function (e) {
                ...
                return (
                  Object.keys(e).forEach(
                    function (n) {
                      var o = e[n];
                      "function" == typeof o && "on" === n.slice(0, 2)
                        ? (this.callbacks[n] = o)
                        : (t[n] = r(o));
                    }.bind(this)
                  ),
              ...
              (l.prototype.receiveEvent = function (e, t) {
                ...
                e !== u.FINISH && e !== u.TIMEOUT && this._initTimeout(),
                  Array.isArray(this._eventsHandle[e]) &&
                    this._eventsHandle[e].forEach(function (e) {
                      try {
                        e(t);
                      } catch (e) {
                        console.error(t);
              ...
              (l.prototype.receiveResponse = function (e, t) {
                ...
                var t = !!t;
                return (
                  t ? this._p._reject(e) : this._p._resolve(e),
                  setTimeout(
                    function () {
            ...
            (function (e, n) {
              ...
              function m(e) {
                var t = this.__data__,
                  n = R(t, e);
                return !(
                  n < 0 || (n == t.length - 1 ? t.pop() : yt.call(t, n, 1), 0)
                );
              }
              function g(e) {
                var t = this.__data__,
              ...
              function D(e, t) {
                ...
                return (
                  n instanceof h &&
                    n.__data__.length == Ae &&
                    (n = this.__data__ = new y(n.__data__)),
                  n.set(e, t),
                  this
                );
              }
              function T(e, t, n) {
                var r = e[t];
                (Et.call(e, t) && Ee(r, n) && (void 0 !== n || t in e)) ||
                  (e[t] = n);
              }
              function R(e, t) {
              ...
              function x(e, t, n, r, o, a, d) {
                var s;
                if ((r && (s = a ? r(e, o, a, d) : r(e)), void 0 !== s))
                  return s;
                if (!ge(e)) return e;
                var u = zt(e);
                if (u) {
                  if (((s = se(e)), !t)) return Q(e, s);
                } else {
                  var l = de(e),
                    v = l == we || l == je;
                  ...
                  if (l == Te || l == Ue || (v && !a)) {
                    if (c(e)) return a ? e : {};
                    if (((s = ue(v ? {} : e)), !t)) return te(e, F(s, e));
                  } else {
                    if (!rt[l]) return a ? e : {};
                    s = ce(e, l, x, t);
                  }
                ...
                var f = d.get(e);
                if (f) return f;
                if ((d.set(e, s), !u)) var p = n ? ne(e) : Ie(e);
                return (
                  i(p || e, function (o, i) {
                    p && ((i = o), (o = e[i])), T(s, i, x(o, t, n, r, i, e, d));
                  }),
                  s
                );
              }
              ...
              function B(e, t) {
                return (
                  Et.call(e, t) ||
                  ("object" == typeof e && t in e && null === ie(e))
                );
              }
              function L(e) {
                return At(Object(e));
              ...
              function ue(e) {
                return "function" != typeof e.constructor || pe(e)
                  ? {}
                  : W(ie(e));
              }
              function ce(e, t, n, r) {
              ...
              function ye(e) {
                return (
                  "string" == typeof e || (!zt(e) && be(e) && Nt.call(e) == xe)
                );
              }
              function Ie(e) {
                var t = pe(e);
                if (!t && !Pe(e)) return L(e);
                var n = le(e),
                  r = !!n,
                  o = n || [],
                  i = o.length;
              ...
              var Ae = 200,
                ...
                nt = /^(?:0|[1-9]\d*)$/,
                rt = {};
              (rt[Ue] = rt["[object Array]"] = rt[ze] = rt[Be] = rt[Ve] = rt[
                Oe
              ] = rt[Le] = rt[qe] = rt[Ge] = rt[Je] = rt[Ye] = rt[Ce] = rt[
                De
              ] = rt[Te] = rt[Re] = rt[Fe] = rt[xe] = rt[We] = rt[He] = rt[
                Ke
              ] = rt[Xe] = rt[Ze] = !0),
              ...
              gt ||
                ...
                ((St && de(new St(new ArrayBuffer(1))) != Be) ||
                  ($t && de(new $t()) != Ce) ||
                  (Ut && "[object Promise]" != de(Ut.resolve())) ||
                  (Vt && de(new Vt()) != Fe) ||
                  (Ot && "[object WeakMap]" != de(new Ot()))) &&
                  (de = function (e) {
                    var t = Nt.call(e),
          ...
          715: function (e, t, n) {
            function r(e, t, n) {
              var r = e[t];
              (M.call(e, t) && s(r, n) && (void 0 !== n || t in e)) ||
                (e[t] = n);
            }
            function o(e, t, n, o) {
              n || (n = {});
            ...
            var f = n(717),
              ...
              y = (function (e) {
                ...
                if (b || d(t) || u(t)) return void o(t, f(t), e);
    ...
    function (e, t, n) {
      ...
      (t.requireModule = function (e) {
        return "undefined" != typeof __weex_require__
          ? __weex_require__("@weex-module/" + e)
          : "undefined" != typeof weex
          ? weex.requireModule(e)
          : void 0;
      }),
          ...
          return Promise.resolve(function (e, n) {
            return new Promise(function (r, o) {
              var i = t.requireModule("nuvajs-exec"),
                ...
                d = a.pop(),
                s = a.join(".");
              i.exec({ plugin: s, action: d, args: n }, function (e) {
                e && "0" === e.errorCode
                  ? ("function" == typeof n.onSuccess && n.onSuccess(e.result),
                    r(e.result))
                  : ("function" == typeof n.onFail && n.onFail(e.result),
                    o(e.result));
              });
            });
          });
          ...
          return Promise.resolve(function (e, n) {
            return new Promise(function (r, o) {
              ...
              i.exec({ plugin: s, action: d, args: n }, function (e) {
                ...
                e && 1 === parseInt(e.__status__ + "", 10)
                  ? ("function" == typeof n.onSuccess && n.onSuccess(t), r(t))
    ...
    function (e, t, n) {
      ...
      (function (e) {
        ...
        var r = function (e, t, n, r) {
          return (
            void 0 === r && (r = void 0),
            { code: e, category: t, message: n, solution: r }
          );
        };
        (t.diagnosticMessageMap = {
          config_debug_deprecated: r(
            1010,
            n.WARN,
            "This is a deprecated feature (dd.debug - debug:true), recommend use dd.devConfig"
          ),
          dd_config_wrap_deprecated: r(
            1020,
            n.WARN,
            "You don 't use a dd.config, so you don't need to wrap dd.ready, recommend remove dd.ready"
          ),
          not_support_event_on: r(
            1030,
            n.WARN,
            "\"event.on\" do not support the current platform ('{0}')"
          ),
          not_support_event_off: r(
            1040,
            n.WARN,
            "\"event.off\" do not support the current platform ('{0}')"
          ),
          repeat_config: r(
            1040,
            n.WARN,
            "dd.config has been executed, please don't repeat config"
          ),
          JsBridge_init_fail: r(
            5010,
            n.ERROR,
            "JsBridge initialization fails, jsapi will not work"
          ),
          auto_bridge_init_error: r(5020, n.ERROR, "auto bridgeInit error"),
          JsBridge_init_fail_dd_config: r(
            5010,
            n.ERROR,
            'JsBridge initialization failed and "dd.config" failed to call'
          ),
          not_support_env: r(
            4040,
            n.ERROR,
            "Do not support the current environment锛�'{0}'"
          ),
          call_api_support_platform_error: r(
            4050,
            n.ERROR,
            "'{0}' do not support the current platform ('{1}')"
          ),
          call_api_config_platform_error: r(
            4060,
            n.ERROR,
            "This API method is not configured for the platform ('{0}')"
          ),
          call_api_on_before_error: r(
            4060,
            n.ERROR,
            "Call Hook:onBeforeInvokeAPI failed , reason: '{0}'"
          ),
          call_api_on_after_error: r(
            4060,
            n.ERROR,
            "Call Hook:onAfterInvokeAPI failed , reason: '{0}'"
          ),
        }),
          (t.formatLog = function (t) {
            ...
            var i =
              ...
              t.code +
              ": " +
              t.message.replace(/{(\d)}/g, function (e, t) {
                return r[t] || e;
              });
            return (
              "object" == typeof e &&
                "production" !==
                  (null === (n = null === e || void 0 === e ? void 0 : e.env) ||
                  void 0 === n
                    ? void 0
                    : n.NODE_ENV) &&
                console.warn(i),
    ...
    function (e, t, n) {
      ...
      function o(e, t) {
        ...
        for (
          var r = e.split(".").map(n), o = t.split(".").map(n), i = 0;
          i < r.length;
          i++
        ) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        (t.compareVersion = o);
      (function (e) {
        (e.cancel = "-1"), (e.not_exist = "1"), (e.no_permission = "7");
      ...
      (function (e) {
        (e.mac = "mac"), (e.win = "win"), (e.noSub = "noSub");
            ...
            return (
              void 0 === n
                ? ((n = function (e) {
                  ...
                  o.set(t, n))
                : -1 === n.__eventTypeList__.indexOf(e) &&
                  n.__eventTypeList__.push(e),
              n
            );
          }
        },
        a = function (e, t) {
          if (o) {
            ...
            return (
              n &&
                -1 !== n.__eventTypeList__.indexOf(e) &&
                n.__eventTypeList__.splice(n.__eventTypeList__.indexOf(e), 1),
              n && n.__eventTypeList__.length <= 1 ? n : void 0
            );
          }
        };
      (t.on = function (e, t) {
        if (-1 !== r.indexOf(e)) document.addEventListener(e, t);
        else {
          var n = i(e, t);
          n
            ? document.addEventListener("dtBizBridgeEvent", n)
            : console.log(
                "bind event : " +
                  e +
                  " need WeakMap support , current environment doesnot"
              );
        }
      }),
        (t.off = function (e, t) {
          if (-1 !== r.indexOf(e)) document.removeEventListener(e, t);
          else {
            var n = a(e, t);
          ...
          return new Promise(function (n, o) {
            ...
            if ((delete t.onSuccess, delete t.onFail, AlipayJSBridge)) {
              var d = e.split("."),
                s = d.pop() || "",
                u = d.join(".");
              AlipayJSBridge.call.apply(null, [
                "webDdExec",
                { serviceName: u, actionName: s, args: t },
                function (e) {
                  var t = {},
                    r = e.content;
                  if (r)
              ...
              var c = new Error(
                "Fatal error, cannot find bridge ,current env is WebView in MiniApp"
              );
              a(c), o(c);
            }
          });
    ...
    function (e, t, n) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        (t.RUNTIME = { WEB: "Web", WEEX: "Weex", UNKNOWN: "Unknown" }),
        (t.PLATFORM = {
          MAC: "Mac",
          WINDOWS: "Windows",
          IOS: "iOS",
    ...
    function (e, t, n) {
      ...
      (t.platformConfig = {
        ...
        bridgeInit: function () {
          var e = o.getENV();
          return e.appType === i.APP_TYPE.MINI_APP
            ? Promise.resolve(a.default)
            : e.appType === i.APP_TYPE.WEBVIEW_IN_MINIAPP
            ? Promise.resolve(d.default)
            : e.appType === i.APP_TYPE.WEEX
            ? u.androidWeexBridge()
            : s.h5AndroidbridgeInit().then(function () {
                return s.default;
              });
        },
        ...
        event: {
          on: function (e, t) {
            ...
            switch (n.appType) {
              ...
              default:
                throw new Error(
                  "Not support global event in the platfrom: " + n.appType
                );
            }
          },
          off: function (e, t) {
      ...
      (t.platformConfig = {
        ...
        bridgeInit: function () {
          ...
          return e.appType === i.APP_TYPE.MINI_APP
            ...
            : e.appType === i.APP_TYPE.WEEX
            ? u.iosWeexBridge()
            : s.h5IosBridgeInit().then(function () {
                return s.default;
              });
        },
        authMethod: "runtime.permission.requestJsApis",
    ...
    function (e, t) {
      ...
      function a() {
        _ &&
          f &&
          ((_ = !1), f.length ? (p = f.concat(p)) : (E = -1), p.length && d());
      }
      function d() {
        if (!_) {
          var e = o(a);
      ...
      (v.nextTick = function (e) {
        ...
        p.push(new s(e, t)), 1 !== p.length || _ || o(d);
      }),
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "5.1.18" }),
        (o[i.ENV_ENUM.android] = { vs: "5.1.18" }),
        o)
      ),
        (t.detectFace$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "6.5.40" }),
        (o[i.ENV_ENUM.android] = { vs: "6.5.40" }),
        o)
      ),
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "6.3.15" }),
        (o[i.ENV_ENUM.android] = { vs: "6.3.15" }),
        o)
      ),
        (t.bindAlipay$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "5.1.8" }),
        (o[i.ENV_ENUM.android] = { vs: "5.1.8" }),
        o)
      ),
        (t.openAuth$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      var o;
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.pay$ = void 0);
      var i = n(0),
        a = "biz.alipay.pay";
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "2.8.0" }),
        (o[i.ENV_ENUM.android] = { vs: "2.8.0" }),
        o)
      ),
        (t.pay$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "6.3.0" }),
        (o[i.ENV_ENUM.android] = { vs: "6.3.0" }),
        o)
      ),
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "5.1.19" }),
        (o[i.ENV_ENUM.android] = { vs: "5.1.19" }),
        o)
      ),
        (t.requestAuthInfo$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      var i = n(0),
        ...
        s = a.genDefaultParamsDealFn({ max: 50 });
      i.ddSdk.setAPI(
        d,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "2.6.0", paramsDeal: s }),
        (o[i.ENV_ENUM.android] = { vs: "2.6.0", paramsDeal: s }),
        (o[i.ENV_ENUM.pc] = { vs: "4.7.11", paramsDeal: s }),
        o)
      ),
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "4.6.25" }),
        (o[i.ENV_ENUM.android] = { vs: "4.6.25" }),
        o)
      ),
        (t.collectSticker$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "4.7.17" }),
        (o[i.ENV_ENUM.android] = { vs: "4.7.17" }),
        (o[i.ENV_ENUM.pc] = { vs: "4.7.17" }),
        o)
      ),
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "4.7.12" }),
        (o[i.ENV_ENUM.android] = { vs: "4.7.12" }),
        (o[i.ENV_ENUM.pc] = { vs: "4.7.12" }),
        o)
      ),
        (t.getRealmCid$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "2.7.6" }),
        (o[i.ENV_ENUM.android] = { vs: "2.7.6" }),
        o)
      ),
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "3.4.10" }),
        (o[i.ENV_ENUM.android] = { vs: "3.4.10" }),
        o)
      ),
        (t.openSingleChat$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "2.4.2" }),
        (o[i.ENV_ENUM.android] = { vs: "2.4.2" }),
        (o[i.ENV_ENUM.pc] = { vs: "4.7.9" }),
        o)
      ),
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "4.6.12" }),
        (o[i.ENV_ENUM.android] = { vs: "4.6.12" }),
        o)
      ),
        (t.sendEmotion$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "2.6.0" }),
        (o[i.ENV_ENUM.android] = { vs: "2.6.0" }),
        o)
      ),
        (t.toConversation$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "5.1.30" }),
        (o[i.ENV_ENUM.android] = { vs: "5.1.30" }),
        (o[i.ENV_ENUM.pc] = { vs: "5.1.33" }),
        o)
      ),
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "2.7.0" }),
        (o[i.ENV_ENUM.android] = { vs: "2.7.0" }),
        (o[i.ENV_ENUM.pc] = { vs: "4.6.1" }),
        o)
      ),
        (t.setData$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "6.0.0" }),
        (o[i.ENV_ENUM.android] = { vs: "6.0.0" }),
        (o[i.ENV_ENUM.pc] = { vs: "6.0.9" }),
        o)
      ),
        (t.createCloudCall$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "5.0.8" }),
        (o[i.ENV_ENUM.android] = { vs: "5.0.8" }),
        (o[i.ENV_ENUM.pc] = { vs: "5.1.28" }),
        o)
      ),
        (t.videoConfCall$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        d,
        ((o = {}),
        (o[i.ENV_ENUM.pc] = { vs: "2.5.0" }),
        (o[i.ENV_ENUM.ios] = { vs: "2.4.0", paramsDeal: s }),
        (o[i.ENV_ENUM.android] = { vs: "2.4.0", paramsDeal: s }),
        o)
      ),
        (t.choose$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "3.1" }),
        (o[i.ENV_ENUM.android] = { vs: "3.1" }),
        o)
      ),
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "2.9.0" }),
        (o[i.ENV_ENUM.android] = { vs: "2.9.0" }),
        (o[i.ENV_ENUM.pc] = { vs: "4.3.5" }),
        o)
      ),
        (t.complexPicker$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "2.4.0" }),
        (o[i.ENV_ENUM.android] = { vs: "2.4.0" }),
        (o[i.ENV_ENUM.pc] = { vs: "4.6.1" }),
        o)
      ),
        (t.createGroup$ = r),
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.pc] = { vs: "4.2.5" }),
        (o[i.ENV_ENUM.ios] = { vs: "3.0" }),
        (o[i.ENV_ENUM.android] = { vs: "3.0" }),
        o)
      ),
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "6.3.16" }),
        (o[i.ENV_ENUM.android] = { vs: "6.3.16" }),
        o)
      ),
        (t.rolesPicker$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "2.15" }),
        (o[i.ENV_ENUM.android] = { vs: "2.15" }),
        o)
      ),
        (t.setRule$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "3.5.6" }),
        (o[i.ENV_ENUM.android] = { vs: "3.5.6" }),
        (o[i.ENV_ENUM.pc] = { vs: "5.1.27" }),
        o)
      ),
        (t.chooseSpaceDir$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "4.5.21" }),
        (o[i.ENV_ENUM.android] = { vs: "4.5.21" }),
        (o[i.ENV_ENUM.pc] = { vs: "4.5.21" }),
        o)
      ),
        (t.delete$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "6.3.30" }),
        (o[i.ENV_ENUM.android] = { vs: "6.3.30" }),
        o)
      ),
    ...
    function (e, t, n) {
      ...
      var i = n(0),
        ...
        s = a.genDefaultParamsDealFn({ isShowCompanyName: !1, max: 50 });
      i.ddSdk.setAPI(
        d,
        ((o = {}),
        (o[i.ENV_ENUM.pc] = { vs: "3.0.0" }),
        (o[i.ENV_ENUM.ios] = { vs: "2.5.2", paramsDeal: s }),
        (o[i.ENV_ENUM.android] = { vs: "2.5.2", paramsDeal: s }),
        o)
      ),
        (t.choose$ = r),
        (t.default = r);
      ...
      i.ddSdk.setAPI(
        ...
        (o[i.ENV_ENUM.ios] = {
          ...
          resultDeal: function (e) {
            return (
              "" === e
                ? (e = { dingCreateResult: !1 })
                : "object" == typeof e &&
                  (e.dingCreateResult = !!e.dingCreateResult),
              e
            );
          },
        }),
        (o[i.ENV_ENUM.android] = { vs: "3.5.1" }),
        (o[i.ENV_ENUM.pc] = { vs: "4.5.9" }),
        o)
      ),
        (t.create$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "6.0.15" }),
        (o[i.ENV_ENUM.android] = { vs: "6.0.15" }),
        o)
      ),
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "6.3.20" }),
        (o[i.ENV_ENUM.android] = { vs: "6.3.20" }),
        o)
      ),
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(a, ((o = {}), (o[i.ENV_ENUM.ios] = { vs: "4.5.0" }), o)),
        (t.notifyWeex$ = r),
        (t.default = r);
    },
    function (e, t, n) {
    ...
    function (e, t, n) {
      ...
      var o;
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.bind$ = void 0);
      var i = n(0),
        a = "biz.iot.bind";
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "4.6.34" }),
        (o[i.ENV_ENUM.android] = { vs: "4.6.34" }),
        o)
      ),
        (t.bind$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "4.6.42" }),
        (o[i.ENV_ENUM.android] = { vs: "4.6.42" }),
        o)
      ),
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(a, ((o = {}), (o[i.ENV_ENUM.pc] = { vs: "5.1.19" }), o)),
        (t.startClassRoom$ = r),
        (t.default = r);
    },
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(a, ((o = {}), (o[i.ENV_ENUM.pc] = { vs: "5.1.18" }), o)),
    ...
    function (e, t, n) {
      ...
      var i = n(0),
        a = n(1),
        d = "biz.map.search",
        s = a.genDefaultParamsDealFn({ scope: 500 });
      i.ddSdk.setAPI(
        d,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "2.4.0", paramsDeal: s }),
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "4.6.37" }),
        (o[i.ENV_ENUM.android] = { vs: "4.6.37" }),
        o)
      ),
        (t.compressVideo$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "4.5.6" }),
        (o[i.ENV_ENUM.android] = { vs: "4.5.6" }),
        o)
      ),
        (t.openApp$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "6.5.31" }),
        (o[i.ENV_ENUM.android] = { vs: "6.5.31" }),
        o)
      ),
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "5.1.31" }),
        (o[i.ENV_ENUM.android] = { vs: "5.1.31" }),
        o)
      ),
    ...
    function (e, t, n) {
      ...
      var o;
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.quit$ = void 0);
      var i = n(0),
        a = "biz.navigation.quit";
      i.ddSdk.setAPI(a, ((o = {}), (o[i.ENV_ENUM.pc] = { vs: "2.5.0" }), o)),
        (t.quit$ = r),
        (t.default = r);
    },
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "3.4.6" }),
        (o[i.ENV_ENUM.android] = { vs: "3.4.6" }),
        o)
      ),
        (t.replace$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      var i = n(0),
        ...
        s = a.genDefaultParamsDealFn({ watch: !0, showIcon: !0, iconIndex: 1 });
      i.ddSdk.setAPI(
        d,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "2.4.0", paramsDeal: s }),
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        d,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "2.6.0", paramsDeal: a.addWatchParamsDeal }),
        (o[i.ENV_ENUM.android] = {
          vs: "2.6.0",
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "5.1.10" }),
        (o[i.ENV_ENUM.android] = { vs: "5.1.10" }),
        o)
      ),
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}), (o[i.ENV_ENUM.android] = { vs: "6.0.13" }), o)
      ),
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "4.7.18" }),
        (o[i.ENV_ENUM.android] = { vs: "4.7.18" }),
        o)
      ),
        (t.subscribe$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "6.5.10" }),
        (o[i.ENV_ENUM.android] = { vs: "6.5.10" }),
        o)
      ),
        (t.getInfo$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "6.5.20" }),
        (o[i.ENV_ENUM.android] = { vs: "6.5.20" }),
        o)
      ),
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}), (o[i.ENV_ENUM.android] = { vs: "4.7.32" }), o)
      ),
        (t.addShortCut$ = r),
        (t.default = r);
    },
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(a, ((o = {}), (o[i.ENV_ENUM.pc] = { vs: "6.5.10" }), o)),
        (t.isTab$ = r),
        (t.default = r);
    },
    function (e, t, n) {
      ...
      var o;
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.call$ = void 0);
      var i = n(0),
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "4.5.8" }),
        (o[i.ENV_ENUM.android] = { vs: "4.5.8" }),
        o)
      ),
        (t.checkPassword$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "6.3.35" }),
        (o[i.ENV_ENUM.android] = { vs: "6.3.35" }),
        (o[i.ENV_ENUM.pc] = { vs: "6.3.35" }),
        o)
      ),
        (t.callComponent$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "5.1.1" }),
        (o[i.ENV_ENUM.android] = { vs: "5.1.1" }),
        o)
      ),
        (t.chooseImage$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(a, ((o = {}), (o[i.ENV_ENUM.pc] = { vs: "6.0.22" }), o)),
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "6.0.19" }),
        (o[i.ENV_ENUM.android] = { vs: "6.0.17" }),
        o)
      ),
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        ...
        ((o = {}),
        (o[i.ENV_ENUM.pc] = { vs: "3.0.0" }),
        (o[i.ENV_ENUM.ios] = { vs: "2.9.1" }),
        (o[i.ENV_ENUM.android] = { vs: "2.9.1" }),
        o)
      ),
        (t.decrypt$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "5.1.14" }),
        (o[i.ENV_ENUM.android] = { vs: "5.1.14" }),
        o)
      ),
        (t.getPerfInfo$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(a, ((o = {}), (o[i.ENV_ENUM.pc] = { vs: "6.0.8" }), o)),
        (t.invokeWorkbench$ = r),
        (t.default = r);
    },
    function (e, t, n) {
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "3.0.0" }),
        (o[i.ENV_ENUM.android] = { vs: "3.0.0" }),
        o)
      ),
        (t.multiSelect$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      var o;
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.open$ = void 0);
      var i = n(0),
        a = "biz.util.open";
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.pc] = { vs: "2.7.0" }),
        (o[i.ENV_ENUM.ios] = { vs: "2.4.0" }),
        (o[i.ENV_ENUM.android] = { vs: "2.4.0" }),
        o)
      ),
    ...
    function (e, t, n) {
      ...
      var i = n(0),
        a = n(1),
        d = "biz.util.openLink",
        s = a.genDefaultParamsDealFn({ credible: !0, showMenuBar: !0 });
      i.ddSdk.setAPI(
        d,
        ((o = {}),
        (o[i.ENV_ENUM.pc] = { vs: "2.7.0" }),
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "4.3.7" }),
        (o[i.ENV_ENUM.android] = { vs: "4.3.7" }),
        (o[i.ENV_ENUM.pc] = { vs: "4.6.33" }),
        o)
      ),
        (t.previewVideo$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "4.1" }),
        (o[i.ENV_ENUM.android] = { vs: "4.1" }),
        o)
      ),
        (t.saveImage$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      var i = n(0),
        a = n(1),
        d = "biz.util.scan",
        s = a.genDefaultParamsDealFn({ type: "qrCode" });
      i.ddSdk.setAPI(
        d,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "2.4.0", paramsDeal: s }),
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "5.1.26" }),
        (o[i.ENV_ENUM.android] = { vs: "5.1.26" }),
        o)
      ),
        (t.setScreenKeepOn$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      var i = n(0),
        a = n(1),
        d = "biz.util.share",
        s = a.genDefaultParamsDealFn({ title: "", buttonName: "纭畾" });
      i.ddSdk.setAPI(
        d,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "2.4.0", paramsDeal: s }),
        (o[i.ENV_ENUM.android] = { vs: "2.4.0", paramsDeal: s }),
        (o[i.ENV_ENUM.pc] = { vs: "4.6.37", paramsDeal: s }),
        o)
      ),
        (t.share$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}), (o[i.ENV_ENUM.android] = { vs: "4.6.33" }), o)
      ),
        (t.startDocSign$ = r),
        (t.default = r);
    },
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "4.5.11" }),
        (o[i.ENV_ENUM.android] = { vs: "4.5.11" }),
        o)
      ),
        (t.systemShare$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "6.5.28" }),
        (o[i.ENV_ENUM.android] = { vs: "6.5.27" }),
        o)
      ),
        (t.uploadFile$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      var i = n(0),
        ...
        s = a.genDefaultParamsDealFn({ multiple: !1 });
      i.ddSdk.setAPI(
        d,
        ((o = {}),
        (o[i.ENV_ENUM.pc] = { vs: "2.5.0" }),
    ...
    function (e, t, n) {
      ...
      var o;
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.ut$ = void 0);
      var i = n(0),
        a = "biz.util.ut",
        d = function (e) {
          var t = Object.assign({}, e),
          ...
          if (n && "object" == typeof n) {
            for (var o in n) void 0 !== n[o] && r.push(o + "=" + n[o]);
            n = r.join(",");
          }
          return (t.value = n || ""), t;
        };
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.pc] = { vs: "3.5.0", paramsDeal: d }),
        (o[i.ENV_ENUM.ios] = {
          vs: "2.4.0",
        ...
        (o[i.ENV_ENUM.android] = { vs: "2.4.0", paramsDeal: d }),
        o)
      ),
        (t.ut$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "6.5.25" }),
        (o[i.ENV_ENUM.android] = { vs: "6.5.25" }),
        o)
      ),
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        ...
        (o[i.ENV_ENUM.ios] = {
          vs: "2.4.0",
          paramsDeal: function (e) {
            return a.forceChangeParamsDealFn({ sensitivity: 3.2 })(
    ...
    function (e, t, n) {
      ...
      var o;
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.stop$ = void 0);
      var i = n(0),
        a = "device.audio.stop";
      i.ddSdk.setAPI(
        a,
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "3.5.0" }),
        (o[i.ENV_ENUM.android] = { vs: "3.5.0" }),
        o)
      ),
        (t.getPhoneInfo$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "4.6.41" }),
        (o[i.ENV_ENUM.android] = { vs: "3.3.0" }),
        o)
      ),
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.android] = { vs: "6.0.27" }),
        (o[i.ENV_ENUM.ios] = { vs: "6.3.15" }),
        o)
      ),
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}), (o[i.ENV_ENUM.android] = { vs: "4.5.0" }), o)
      ),
        (t.checkPermission$ = r),
        (t.default = r);
    },
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "3.4.7" }),
        (o[i.ENV_ENUM.android] = { vs: "3.4.7" }),
        o)
      ),
        (t.start$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "3.4.8" }),
        (o[i.ENV_ENUM.android] = { vs: "3.4.8" }),
        o)
      ),
        (t.status$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "2.5.0" }),
        (o[i.ENV_ENUM.android] = { vs: "2.5.0" }),
        o)
      ),
        (t.extendModal$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      var i = n(0),
        ...
        s = a.genDefaultParamsDealFn({ text: "鍔犺浇涓�...", showIcon: !0 });
      i.ddSdk.setAPI(
        d,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "2.4.0", paramsDeal: s }),
    ...
    function (e, t, n) {
      ...
      var i = n(0),
        ...
        s = a.genDefaultParamsDealFn({ text: "toast", duration: 3, delay: 0 });
      i.ddSdk.setAPI(
        d,
        ((o = {}),
        (o[i.ENV_ENUM.pc] = {
    ...
    function (e, t, n) {
      ...
      var i = n(0),
        ...
        s = a.genDefaultParamsDealFn({ duration: 300 });
      i.ddSdk.setAPI(
        d,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "2.4.0", paramsDeal: s }),
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(a, ((o = {}), (o[i.ENV_ENUM.ios] = { vs: "4.6.18" }), o)),
        (t.insetAdjust$ = r),
        (t.default = r);
    },
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.android] = { vs: "4.0.0" }),
        (o[i.ENV_ENUM.ios] = { vs: "4.0.0" }),
        o)
      ),
        (t.resetView$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "5.1.12" }),
        (o[i.ENV_ENUM.android] = { vs: "5.1.12" }),
        (o[i.ENV_ENUM.pc] = { vs: "5.1.12" }),
        o)
      ),
        (t.keepAlive$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}), (o[i.ENV_ENUM.android] = { vs: "4.5.16" }), o)
      ),
        (t.loginGovNet$ = r),
        (t.default = r);
    },
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "6.0.10" }),
        (o[i.ENV_ENUM.android] = { vs: "6.0.10" }),
        o)
      ),
        (t.getLoadTime$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.pc] = { vs: "3.0.0", paramsDeal: d }),
        (o[i.ENV_ENUM.ios] = { vs: "2.4.0" }),
        (o[i.ENV_ENUM.android] = { vs: "2.4.0" }),
        o)
      ),
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.pc] = { vs: "3.3.0", paramsDeal: d }),
        (o[i.ENV_ENUM.ios] = { vs: "3.3.0" }),
        (o[i.ENV_ENUM.android] = { vs: "3.3.0" }),
        o)
      ),
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        a,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "6.5.0" }),
        (o[i.ENV_ENUM.android] = { vs: "6.5.0" }),
        o)
      ),
        (t.addToFloat$ = r),
        (t.default = r);
    ...
    function (e, t, n) {
      ...
      i.ddSdk.setAPI(
        d,
        ((o = {}),
        (o[i.ENV_ENUM.ios] = { vs: "2.4.0", paramsDeal: a.addWatchParamsDeal }),
        (o[i.ENV_ENUM.android] = {
          vs: "2.4.0",
          paramsDeal: a.addWatchParamsDeal,
        }),
        ...
        return (
          r ||
            (r = new Promise(function (e, t) {
              var n = function () {
                try {
                  (window.WebViewJavascriptBridgeAndroid =
                    window.nuva && window.nuva.require()),
                    e({});
                } catch (e) {
                  t(e);
                }
              ...
              window.nuva &&
              (void 0 === window.nuva.isReady || window.nuva.isReady)
                ? n()
        ...
        return (
          ...
          r.then(function () {
            return new Promise(function (t, r) {
              ...
              "function" == typeof window.WebViewJavascriptBridgeAndroid &&
                window.WebViewJavascriptBridgeAndroid(d, s, a, i, n);
            });
          })
        );
      };
              ...
              if (!0 === t.watch) {
                ...
                delete t.onSuccess,
                  "undefined" != typeof WebViewJavascriptBridge &&
                    WebViewJavascriptBridge.registerHandler(e, function (e, t) {
                      "function" == typeof o && o.call(null, e),
                        t && t({ errorCode: "0", errorMessage: "success" });
                    });
              }
              void 0 !== window.WebViewJavascriptBridge &&
                window.WebViewJavascriptBridge.callHandler(
                  ...
                  function (e) {
                    var o = e || {};
                    "0" === o.errorCode
                      ? ("function" == typeof t.onSuccess &&
                          t.onSuccess.call(null, o.result),
                        n(o.result))
                      : ("-1" === o.errorCode && "function" == typeof t.onCancel
                          ? t.onCancel.call(null, o, o.errorCode)
                          : "function" == typeof t.onFail &&
                            t.onFail.call(null, o, o.errorCode),
                        r(o));
                  }
                );
            });
        ...
        return new Promise(function (r, o) {
          return n(6)
            ...
            .result.then(
              function (e) {
                return (
                  "function" == typeof t.onSuccess && t.onSuccess.call(null, e),
                  r(e)
                );
              },
              function (e) {
                return (
                  "function" == typeof t.onFail && t.onFail.call(null, e), o(e)
                );
              }
            );
        });
      ...
      (t.ios = o.platform === r.ENV_ENUM.ios),
        ...
        (t.compareVersion = function (e, t, n) {
          ...
          for (
            var o,
              i,
              a = e.split("-")[0].split(".").map(r),
              d = t.split("-")[0].split(".").map(r);
            o === i && d.length > 0;
      ...
      function r(e, t, n) {
        var r = "Web" === n.platform,
          ...
          c = (function () {
            return d
              ? "DingTalk" === n.appName ||
                  "com.alibaba.android.rimet" === n.appName
              : s.indexOf("dingtalk") > -1 || !!u.containerId;
          })(),
          l = (function () {
            if (r) {
          ...
          switch (s) {
            case i.FRAMEWORK.VUE:
              ...
              (e.platform = n.platform),
                i.RUNTIME.WEEX === d &&
                  ((e.appVersion = n.appVersion), (e.appName = n.appName));
              break;
          ...
          return i(this, function (i) {
            return (
              ...
              o
                ...
                : [
                    2,
                    this.bridgeInitFn().then(function (e) {
                      return e(t || n, r);
                    }),
                  ]
            );
    ...
    function (e, t, n) {
      ...
      function r(e, t) {
        return o(this, void 0, void 0, function () {
          ...
          return i(this, function (i) {
            return (
              !1 === this.devConfig.isAuthApi && (e.isAuthApi = !1),
              (n = e.isAuthApi),
              (r = e.method),
              ...
              o || !n
                ? ((d = void 0),
                  ...
                  d || !n
                    ? [2, t()]
                    : ((s = a.formatLog(
                        a.diagnosticMessageMap.call_api_support_platform_error,
                        r,
                        this.env.platform
                      )),
                      [
                        ...
                        Promise.reject({
                          errorCode:
                            a.diagnosticMessageMap
                              .call_api_support_platform_error.code,
                          errorMessage: s,
                        }),
                      ]))
                : ((s = a.formatLog(
                    a.diagnosticMessageMap.call_api_config_platform_error,
                    this.env.platform
                  )),
                  [
                    2,
            ...
            switch (p.label) {
              case 0:
                return (
                  ...
                  (d = e.apiConfig),
                  (s =
                    this.devConfig.forceEnableDealApiFnMap &&
                    this.devConfig.forceEnableDealApiFnMap[n] &&
                    !0 === this.devConfig.forceEnableDealApiFnMap[n](r)),
                  (u =
                    !s &&
                    (!0 === this.devConfig.isDisableDeal ||
                      (this.devConfig.disbaleDealApiWhiteList &&
                        -1 !==
                          this.devConfig.disbaleDealApiWhiteList.indexOf(n)))),
                  (c = {}),
                  !u && d && d.paramsDeal && a.isFunction(d.paramsDeal)
                    ? [4, d.paramsDeal(r)]
                    : [3, 2]
                );
              case 1:
              ...
              case 3:
                return (
                    ...
                    return o(f, void 0, void 0, function () {
                      return i(this, function (t) {
                        return !u &&
                          d &&
                          d.resultDeal &&
                          a.isFunction(d.resultDeal)
                          ? [2, d.resultDeal(e)]
                          : [2, e];
                      });
                    });
                  }),
                  a.isFunction(c.onSuccess) &&
                    ((v = c.onSuccess),
                  ...
                  Object.assign(e, {
                    callParams: c,
                    invokeName:
                      null === d || void 0 === d ? void 0 : d.invokeName,
                  }),
                  [2, t().then(l)]
                );
            }
          ...
          return i(this, function (i) {
            switch (i.label) {
              case 0:
                if (
                  ...
                  try {
                    ...
                    a.formatLog(
                      a.diagnosticMessageMap.call_api_on_before_error,
                      e.toString()
                    );
                  }
                (c = !0), (i.label = 1);
              ...
              case 2:
                return (s = i.sent()), [3, 4];
              case 3:
                return (l = i.sent()), (u = l), (c = !1), [3, 4];
              case 4:
                if (((v = c ? s : u), this.devConfig.onAfterInvokeAPI))
                  try {
                    ...
                    a.formatLog(
                      a.diagnosticMessageMap.call_api_on_after_error,
                      e.toString()
                    );
                  }
      ...
      function r(e, t) {
        return o(this, void 0, void 0, function () {
          return i(this, function (n) {
            return [
              2,
              this.bridgeInitFn().then(function (n) {
                return (e.JSBridge = n), t();
              }),
            ];
          });
        });
              ...
              case 2:
                return (
                  ...
                  (u =
                    this.hadConfig &&
                    void 0 === this.isReady &&
                    -1 !== this.configJsApiList.indexOf(r)),
                  (c =
                    "object" == typeof n &&
                    "string" == typeof n.errorCode &&
                    n.errorCode === d.ERROR_CODE.no_permission),
                  (l =
                    "object" == typeof n &&
                    "string" == typeof n.errorCode &&
                    n.errorCode === d.ERROR_CODE.cancel),
                  (v = a.getTargetApiConfigVS(s, this.env)),
                  (f =
                    v &&
                    this.env.version &&
                    d.compareVersion(this.env.version, v)),
                  (p =
                    (this.env.platform === d.ENV_ENUM.ios ||
                      this.env.platform === d.ENV_ENUM.android) &&
                    u &&
                    c),
                  (_ =
                    this.env.platform === d.ENV_ENUM.pc &&
                    u &&
                    ((f && !l && o) || c)),
                  p || _
                    ? [
      ...
      function r(e, t) {
        return o(this, void 0, void 0, function () {
          ...
          return i(this, function (i) {
            switch (i.label) {
              case 0:
                (n = e.method), (r = e.params), (s = !0), (i.label = 1);
              case 1:
                return i.trys.push([1, 3, , 4]), [4, t()];
              case 2:
                return (o = i.sent()), [3, 4];
              case 3:
                return (u = i.sent()), (d = u), (s = !1), [3, 4];
              case 4:
                return (
                  (c = s ? o : d),
    ...
    function (e, t, n) {
      ...
      r.ddSdk.setPlatform({
        ...
        event: {
          on: function (e, t) {
            if (o.getENV().appType === d.APP_TYPE.WEB) return s.on(e, t);
          },
          off: function (e, t) {
            if (o.getENV().appType === d.APP_TYPE.WEB) return s.off(e, t);
          },
        },
      });
    },
    function (e, t, n) {
      ...
      function r(e) {
        ...
        return o._invoke("biz.util.callComponent", {
          ...
          params: {
            url:
              "/im/cool-app-component.html?corpId=" +
              encodeURIComponent(
                null ===
    ...
    function (e, t, n) {
      "use strict";
      function r(e) {
        var t = Object.assign({}, e, { isBatchApi: !0 });
        return o._invoke("biz.util.callComponent", {
          componentType: "h5",
          params: {
            url:
              "/resource-picker/" +
              (i.isMobile ? "mob" : "index") +
              ".html?scene=addCoolAppToGroup&params=" +
        ...
        return o._invoke("biz.util.callComponent", {
          ...
          params: {
            url:
              ...
              "#/send-message?params=" +
              encodeURIComponent(
                JSON.stringify({ body: e, bodyLengthList: [n] })
              ),
            target: "float",
            title: "鎻愮ず",
        ...
        return o._invoke("biz.util.callComponent", {
          ...
          params: {
            url:
              ...
              "#/send-message-to-single-chat?params=" +
              encodeURIComponent(
                JSON.stringify({ body: e, bodyLengthList: [n] })
              ),
            target: "float",
    ...
    function (e, t, n) {
      ...
      var r = n(3),
        o = n(873),
        i = n(273),
        a = Object.assign(r, o.apiObj, { plugin: i });
      e.exports = a;
    },
    ,
    ,
    ...
    function (e, t, n) {
      ...
      t.apiObj = {
        biz: {
          ...
          chat: {
            ...
            toConversationByOpenConversationId:
              A.toConversationByOpenConversationId$,
          },
          clipboardData: { setData: S.setData$ },
          conference: {
          ...
          ding: { create: H.create$, post: K.post$ },
          edu: {
          ...
          event: { notifyWeex: oe.notifyWeex$ },
          intent: { fetchData: ie.fetchData$ },
          iot: {
            bind: ae.bind$,
          ...
          map: { locate: _e.locate$, search: Ee.search$, view: Ne.view$ },
          media: { compressVideo: Pe.compressVideo$ },
          microApp: { openApp: he.openApp$ },
          navigation: {
            close: Me.close$,
            goBack: me.goBack$,
            hideBar: ge.hideBar$,
          ...
          shortCut: { addShortCut: Le.addShortCut$ },
          store: {
          ...
          user: { checkPassword: et.checkPassword$, get: tt.get$ },
          util: {
        ...
        channel: { permission: { requestAuthCode: Gt.requestAuthCode$ } },
        device: {
          accelerometer: {
          ...
          connection: { getNetworkType: vn.getNetworkType$ },
          geolocation: {
        ...
        net: { bjGovApn: { loginGovNet: Wn.loginGovNet$ } },
        runtime: {
          message: { fetch: zn.fetch$, post: Bn.post$ },
          monitor: { getLoadTime: Ln.getLoadTime$ },
          permission: {
        ...
        ui: {
          ...
          progressBar: { setColors: tr.setColors$ },
          pullToRefresh: {
            disable: nr.disable$,
            enable: rr.enable$,
            stop: or.stop$,
          },
          webViewBounce: { disable: ir.disable$, enable: ar.enable$ },
        },
        util: {
          domainStorage: {
            getItem: dr.getItem$,
          ...
          openTemporary: { getData: cr.getData$ },
        },
      };
    },
    ,
